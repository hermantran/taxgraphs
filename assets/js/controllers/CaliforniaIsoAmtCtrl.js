...
/* @ngInject */
function CaliforniaIsoAmtCtrl($scope, $filter, taxData, taxService, graph, settings) {
  ...
  function updateGraphText(state, year) {
    ...
    const primaryTitle = `California Income Tax - Ordinary Income vs AMT, ${year}`;
  ...
  function drawGraph() {
    ...
    graph.addLine({
      ...
      label: 'California Income Tax - Ordinary Income',
    ...
    graph.addLine({
      ...
      label: 'California Income Tax - AMT',
...
export default CaliforniaIsoAmtCtrl;
